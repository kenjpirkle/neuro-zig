...
pub const QuadShader = struct {
    ...
    texture_transforms_location: GLint,
    font: Font(128, 16),
    quad_data: MapBuffer(Quad, 1024),
    draw_command_data: MapBuffer(DrawArraysIndirectCommand, 64),
    colour_index_data: MapBuffer(QuadColourIndices, 1024),
    colour_data: MapBuffer(Colour, 128),
